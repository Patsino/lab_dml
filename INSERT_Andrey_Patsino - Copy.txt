...
select str.staff_id, str.first_name, 
  str.last_name, str.store_id, str.total_revenue
from staff_overall_revenue str
where not exists (
    select 1 from staff_overall_revenue str2
    where str2.store_id = str.store_id and str2.total_revenue > str.total_revenue
);
